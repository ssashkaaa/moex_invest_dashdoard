    ...
    if tickers: #проводим инвестиционный анализ в случае, если пользователь выбрал хотя бы одну акцию
        ...
        with col1:
            ...
            **Доходность инвестиционного портфеля**  
            ...
            with col2:
                st.markdown(f"""
                **Волатильность ежедневной доходности акций**  
                {risk:.2%}
                """)
            with col3:
                st.markdown(f"""
        ...
        if returns.shape[1] > 1:
            ...
            st.markdown("""
            **Случайные инвестиционные портфели** образуют облако. Каждый портфель в нём — это одна из тысяч случайных комбинаций акций.  

            **Ваш портфель** показан чёрной точкой.  

            **Оптимальный портфель** показан красной звездой. Это самая эффективная комбинация активов, которая даёт максимальную доходность при вашем уровне риска.
            """)
